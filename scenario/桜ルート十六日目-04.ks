...
@pg
*page1|
　ここでセイバーに斬りかかったところで何になる。[lr]
　既に準備に入ってしまった投影で何ができる。[lr]
　俺たちの作戦は決まっている。[lr]
　ライダーはそれを受け入れて、俺を一時でもマスターだと認めてくれた。[lr]
@r
　それを[line4]
@pg
*page2|
...
@r
　セイバーの剣が空を切る。[lr]
　ライダーは既にセイバーの間合いから離脱していた。[lr]
　それも最大まで。[lr]
　この空洞の端にまで、彼女は間合いを引き離す。
@pg
*page3|
　セイバーは追撃できない。[lr]
　その両足には、ライダーの鎖が絡まっている。[lr]
　ライダーが膝をついたのはその為だ。[lr]
...
「[line4]！」[lr]
　だが遅い。[lr]
　わずか二秒の間隙だったが、それでも、ライダーにとっては充分すぎる“助走距離”を引き離せた。
@pg
*page6|
@textoff
...
　　　「“[line4][ruby text=カリバー char=4]勝利の剣！！！！！”」[wsay canskip=1]
@textoff
